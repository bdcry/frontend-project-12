...
const RenameChannelModal = () => {
  ...
  const currentChannel = channelsData.find((ch) => ch.id === activeChannelId);
  ...
  return (
    <Modal
      show={modalStatus}
      onHide={() => dispatch(setStatusChannelModal({
        modalName: 'renameChannelModal',
        status: false,
        channelId: null,
      }))}
    ...
    >
      <Modal.Header>
        ...
        <Button
          ...
          variant="close"
          onClick={() => dispatch(setStatusChannelModal({
            modalName: 'renameChannelModal',
            status: false,
            channelId: null,
          }))}
      ...
      <Modal.Body>
        <Form onSubmit={formik.handleSubmit}>
          <Form.Group>
            ...
            />
            <label className="visually-hidden" htmlFor="name">{t('renameChannelModal.label')}</label>
            {formik.errors.name && (
